	...
	function init()
	{
		screen = new Ajax.PeriodicalUpdater('', '<?= base_url() ?>assets/gps_data_reader.php', { method: 'get', frequency: 10.0,onSuccess: function(t) {
	...
	function initalizeMap() {
		...
		var goal = new OpenLayers.Icon('<?= base_url() ?>assets/img/chequered_flag.png',size2,offset);
        var icon = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker1.png',size,offset);
		var icon2 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker2.png',size,offset);
		var icon3 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker3.png',size,offset);
		var icon4 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker4.png',size,offset);
		var icon5 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker5.png',size,offset);
		var icon6 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker6.png',size,offset);
		var icon7 = new OpenLayers.Icon('<?= base_url() ?>assets/img/marker7.png',size,offset);

			...
			<div class="cont">
				...
				<table class="table">
					...
					foreach($records as $r) {
						$k++;
					echo "<tr>";
						echo "<td>".$r->terminalnombre."</td>";
						echo "<td>".$r->nombre."</td>";
						echo "<td><a href = '".site_url()."adm_terminal/update_view/"
							.$r->id."' class='btn btn-success btn-xs' role='button'><span class='glyphicon glyphicon-edit'></span></a></td>";
							echo "<td><button class='btn btn-danger btn-xs' role='button' data-toggle='modal' data-target='#myModal".$k."'s><span class='glyphicon glyphicon-trash'></span></a></td>";
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        <div class="modal-body">
								        	'."<a href = '".site_url("adm_terminal/eliminar/")
								.$r->id."' class='btn btn-danger'>Eliminar</a>"."   "."<a href = '".site_url("adm_terminal")."' class='btn btn-default'>Cancelar</a>".'
								        </div>
								      </div>
								    </div>'; 
								echo "<tr>";

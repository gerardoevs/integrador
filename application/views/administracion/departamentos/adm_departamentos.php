		...
		<div class="col-sm-12">
			<div class="cont">
				...
				<table class="table">
					...
					echo "<tr>";
						echo "<td>".$r->nombre."</td>";
						echo "<td><a href = '".site_url()."adm_departamentos/update_view/"
							.$r->idDepartamentos."' class='btn btn-success btn-xs' role='button'><span class='glyphicon glyphicon-edit'></span></a></td>";
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        <div class="modal-body">
								        	'."<a href = '".site_url("adm_departamentos/eliminar/")
								.$r->idDepartamentos."' class='btn btn-danger'>Eliminar</a>"."   "."<a href = '".site_url("adm_departamentos")."' class='btn btn-default'>Cancelar</a>".'
								        </div>
								      </div>
								    </div>';
								echo "<tr>";
